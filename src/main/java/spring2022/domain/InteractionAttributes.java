...
public class InteractionAttributes {
    public static final InteractionAttributes NVL = new InteractionAttributes(Entity.NVL, Hero.NVL, /*null,*/ 0, 0,0, 0, false, new Coordinate(0, 0), new Coordinate(0, 0), 0);
